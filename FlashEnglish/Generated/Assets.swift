...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let imgX = ImageAsset(name: "img__x")
    internal static let imgBlog = ImageAsset(name: "img_blog")
    internal static let imgGithub = ImageAsset(name: "img_github")
    internal static let imgInstagram = ImageAsset(name: "img_instagram")
  }
  internal enum Colors {
    ...
    internal static let defaultBlue = ColorAsset(name: "defaultBlue")
    internal static let defaultWhite = ColorAsset(name: "default_white")
